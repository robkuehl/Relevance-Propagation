...
class mc_cnn_classifier:
    ...
    def __init__(self, model_type:str, dataset:str, final_activation:str, loss:str, classes:list):
    ...
    def run_model(self, batch_size, epochs):
        ...
        storage_path = pathjoin(self.storage_path, '{}_{}_{}_{}.h5'.format(self.dataset, self.model_type, 'multiclass', dt))
