...
from src.models.help_functions.models import get_cnn_model


class mc_classifier:
    
    def __init__(self, model_name:str, dataset:str, storage_path:Path, model_type:str='cnn', model_path: str=None):
    ...
    def create_model(self):
        ...
        #     self.model = get_dense_model(model_name=self.model_name, input_shape=self.input_shape, output_shape=self.output_shape, final_activation=self.final_activation)
            ...
            raise ValueError("Currently only model_type cnn supported")
    ...
    def run_model(self, batch_size, epochs):
        ...
        # Erstellen der Iterator für Validierung und Evaluierung (keine Augmentation)
        ...
        #checkpoint = ModelCheckpoint(storage_path, monitor=self.monitor, verbose=1, save_best_only=True, save_weights_only=False, period=1, mode='auto')
